...
public class SignUpView extends JFrame {
    ...
    private JCheckBox jCheckBoxScales = new JCheckBox("Scales, Fins, and Other");
    ...
    public SignUpView() {
        ...
        jCheckBoxScales.setBounds(30, 430, 200, 25);
        panel.add(jCheckBoxScales);

        jCheckBoxSmallF.setBounds(30, 450, 200, 25);
        panel.add(jCheckBoxSmallF);

        jCheckBoxHorses.setBounds(30, 470, 200, 25);
        panel.add(jCheckBoxHorses);

        jCheckBoxBarnyard.setBounds(30, 490, 200, 25);
    ...
    public String getRePass() {
        String userRePass = rePass.getText();
        return userRePass;
    }
    ...
    public String getRadius() {
        String userRadius = searchDistance.getText();
        return userRadius;
    }
