 ...
 * @author biscu
 */
public class RabbitParameters extends javax.swing.JFrame {

    /**
     * Creates new form RabbitParameters
     */
    public RabbitParameters() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RabbitParameters.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RabbitParameters().setVisible(true);
            }
        });
    }
