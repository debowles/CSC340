 ...
 * @author biscu
 */
public class BirdParameters extends javax.swing.JFrame {

    /**
     * Creates new form BirdParameters
     */
    public BirdParameters() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BirdParameters.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BirdParameters().setVisible(true);
            }
        });
    }
