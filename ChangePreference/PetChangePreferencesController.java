...
public class PetChangePreferencesController {
    ...
    public PetChangePreferencesController(PetChangePreferencesView _theView, PetChangePreferencesModel _theModel) {
    ...
    class dogPreferencesListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            DogPreferencesController theController = new DogPreferencesController(theView, theModel);
    ...
    class catPreferencesListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            CatPreferencesController theController = new CatPreferencesController(theView, theModel);
            theView.setVisible(true);
        }
    }
    ...
    class birdPreferencesListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            BirdPreferencesController theController = new BirdPreferencesController(theView, theModel);
            theView.setVisible(true);
        }
    }
    ...
    class horsesPreferencesListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            HorsesPreferencesController theController = new HorsesPreferencesController(theView, theModel);
            theView.setVisible(true);
        }
    }
    ...
    class rabbitPreferencesListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            RabbitPreferencesController theController = new RabbitPreferencesController(theView, theModel);
            theView.setVisible(true);
        }
    }
    ...
    class scalesAndOtherPreferencesListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            ScalesAndOtherPreferencesController theController = new ScalesAndOtherPreferencesController(theView, theModel);
            theView.setVisible(true);
        }
    }
    ...
    class barnyardPreferencesListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            BarnyardPreferencesController theController = new BarnyardPreferencesController(theView, theModel);
            theView.setVisible(true);
        }
    }
    ...
    class samllAndFurryPreferencesListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            SmallAndFurryPreferencesController theController = new SmallAndFurryPreferencesController(theView, theModel);
            theView.setVisible(true);
        }
    }
