...
public class PetHistoryModel {
    ...
    public void setAnimalListIndex(int animalListIndex) {
        this.animalListIndex = animalListIndex;
    }
    ...
    public void setAnimalListLength(int animalListLength) {
        this.animalListLength = animalListLength;
    }
